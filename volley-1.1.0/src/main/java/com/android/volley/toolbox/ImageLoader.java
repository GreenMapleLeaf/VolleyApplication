...
public class ImageLoader {
    ...
    /**
     * The fans avatar implementation to be used in MyVolley.
     */
    private final FansAvatar mAvatar;
     ...
     *
     */
    public ImageLoader(RequestQueue queue, ImageCache imageCache, FansAvatar avatar) {
        mRequestQueue = queue;
        mCache = imageCache;
        mAvatar = avatar;
    }
    ...
    public ImageContainer get(String requestUrl, ImageListener imageListener,
        ...
        Request<Bitmap> newRequest = makeImageRequest(requestUrl, maxWidth, maxHeight, scaleType,
                cacheKey);
        // add here, set avatar no cache
        if(mAvatar != null && mAvatar.isAvatarUrl(requestUrl)){
